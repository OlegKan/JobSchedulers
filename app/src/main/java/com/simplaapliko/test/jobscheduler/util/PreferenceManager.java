...
public class PreferenceManager {
    ...
    private static final String PREFERENCES = "com.simplaapliko.test.jobscheduler.preferences";
    ...
    public int getJobId() {
        return mContext.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE)
                .getInt(PREF_JOB_ID, 0);
    }

    public void setJobId(int count) {
        mContext.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE)
                .edit()
                .putInt(PREF_JOB_ID, count)
                .apply();
    }
}
